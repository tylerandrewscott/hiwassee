...
gen shortterm = 0
gen shortterm = 1 if snp == "S:A-1" | snp == "S:P-1"| snp == "S:A-1+"| snp == "S:SP-1+" | snp == "S:A/A-1" | snp == "S:A+/A-1" | snp == "S:AA+/A-1"

gen snp_dealrate = 0 
replace snp_dealrate = 1 if snp == "S:BBB-"
replace snp_dealrate = 1 if snp == "S:BBB+"
replace snp_dealrate = 1 if snp == "S:A-"
replace snp_dealrate = 1 if snp == "S:A/A-"
replace snp_dealrate = 1 if snp == "S:A/A-1"
replace snp_dealrate = 1 if snp == "S:A"
replace snp_dealrate = 2 if snp == "S:A+"
replace snp_dealrate = 2 if snp == "S:A+/A-1"
replace snp_dealrate = 3 if snp == "S:AA-"
replace snp_dealrate = 3 if snp == "S:AA-/A"
replace snp_dealrate = 3 if snp == "S:AA-/BBB-"
replace snp_dealrate = 3 if snp == "S:AA-/BBB+"
replace snp_dealrate = 4 if snp == "S:AA"
replace snp_dealrate = 4 if snp == "S:AA/A"
replace snp_dealrate = 4 if snp == "S:AA/A+"
replace snp_dealrate = 4 if snp == "S:AA/A-"
replace snp_dealrate = 5 if snp == "S:AA+"
replace snp_dealrate = 5 if snp == "S:AA+/A-1"
replace snp_dealrate = 5 if snp == "S:A-1" //short term
replace snp_dealrate = 5 if snp == "S:P-1" //short term
replace snp_dealrate = 6 if snp == "S:AAA"
replace snp_dealrate = 6 if snp == "S:A-1+" //short term
replace snp_dealrate = 6 if snp == "S:SP-1+" //short term
...
replace shotterm =1 if moodys == "M:A1" | moodys == "M:A1/VMIG-1" | moodys == "M:A1/VMIG 1" | moodys == "M:Aa2/VMIG1" | moodys == "M:MIG 1" | moodys == "M:MIG1" | moodys == "M:P-1"
gen moodys_dealrate = 0
replace moodys_dealrate = 1 if moodys == "M:Baa1"
replace moodys_dealrate = 1 if moodys == "M:A3"
replace moodys_dealrate = 1 if moodys == "M:A3/Baa1"
replace moodys_dealrate = 1 if moodys == "M:A2"
replace moodys_dealrate = 2 if moodys == "M:A1"
replace moodys_dealrate = 2 if moodys == "M:A1" // short term
replace moodys_dealrate = 2 if moodys == "M:A1/VMIG-1"
replace moodys_dealrate = 2 if moodys == "M:A1/VMIG 1"
replace moodys_dealrate = 3 if moodys == "M:Aa3"
replace moodys_dealrate = 4 if moodys == "M:Aa2"
replace moodys_dealrate = 4 if moodys == "M:Aa2/VMIG1"
replace moodys_dealrate = 5 if moodys == "M:Aa1"
replace moodys_dealrate = 5 if moodys == "M:AA1"
replace moodys_dealrate = 5 if moodys == "M:AA+"
replace moodys_dealrate = 6 if moodys == "M:Aaa"
replace moodys_dealrate = 6 if moodys == "M:AAA"
replace moodys_dealrate = 6 if moodys == "M:MIG 1" //short term
replace moodys_dealrate = 6 if moodys == "M:MIG1" // short term
replace moodys_dealrate = 6 if moodys == "M:P-1" // short term
...
gen fitch_dealrate =0fitch == "F:AA/F1" | fitch == "F:AA/F1+" | fitch == "F:F1" |fitch == "F:AAA/F1+ |fitch == "F:F-1+" | fitch == "F:F1+"
replace shortterm =1 if 
replace fitch_dealrate = 1 if fitch == "F:BBB-"
replace fitch_dealrate = 1 if fitch == "F:A-"
replace fitch_dealrate = 1 if fitch == "F:A"
replace fitch_dealrate = 2 if fitch == "F:A+"
replace fitch_dealrate = 3 if fitch == "F:AA-"
replace fitch_dealrate = 4 if fitch == "F:AA"
replace fitch_dealrate = 4 if fitch == "F:AA/F1"
replace fitch_dealrate = 4 if fitch == "F:AA/F1+"
replace fitch_dealrate = 5 if fitch == "F:AA+"
replace fitch_dealrate = 5 if fitch == "F:F1" // short term
replace fitch_dealrate = 6 if fitch == "F:AAA" 
replace fitch_dealrate = 6 if fitch == "F:AAA/F1+" 
replace fitch_dealrate = 6 if fitch == "F:F-1+" // short term 
replace fitch_dealrate = 6 if fitch == "F:F1+" //short term
